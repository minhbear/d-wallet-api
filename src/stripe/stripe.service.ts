...
export class StripeService {
  ...
  async handlePaymentIntentSuccess(paymentIntent: Stripe.PaymentIntent): Promise<void> {
  ...
  async handlePaymentIntentFail(paymentIntent: Stripe.PaymentIntent): Promise<void> {
    const { transactionId } = paymentIntent.metadata;
